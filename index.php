...
<main>
  ...
  <div class="hero-image-container" id = "Top">
        <img src="<?php echo get_template_directory_uri();?>/img/hero_img.jpg">
          <div class="hero-text">
              <h1>夢からデジタルへ</h1>
    ...
    <div class="works">
      <div class="button-grid">
        ...
        <div class="button-item">
          ...
          <?php else: ?>
            <a class="modal-button" href="<?php the_permalink(); ?>">
              <img src="<?php echo get_template_directory_uri(); ?>/img/lab1.jpg" alt="投稿がありません">
            </a>
          <?php endif; ?>
        </div>      
            <?php endwhile; else: ?>
